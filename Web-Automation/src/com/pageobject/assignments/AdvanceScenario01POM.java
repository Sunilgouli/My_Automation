...
public class AdvanceScenario01POM {
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateUserLastName().sendKeys("rahul");
			oPage.getCreateUserEmail().sendKeys("sunilmechani@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser2()
	{
		try
		{
			...
			oPage.getCreateUserLastName().sendKeys("rahul2");
			oPage.getCreateUserEmail().sendKeys("sunilmechani2@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser3()
	{
		try
		{
			...
			oPage.getCreateUserLastName().sendKeys("rahul3");
			oPage.getCreateUserEmail().sendKeys("sunilmechani3@gmail.com");
			Thread.sleep(2000);
